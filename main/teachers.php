                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="teachers-grid.php" class="btn btn-outline-gray me-2"><i
                                                class="feather-grid"></i></a>
                                        <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i>
                                            Download</a>
                                        <a href="#" class="btn btn-outline-secondary me-2"><i class="fa fa-trash"></i>
                                            Delete </a>
                                        <a href="#" class="btn btn-outline-secondary me-2"><i class="fa fa-eye"></i>
                                            View All </a>
