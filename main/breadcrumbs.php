...
<li><a href="breadcrumbs.html" class="active">Breadcrumb</a></li>
...
<ol class="breadcrumb pre-breadcrumb text-muted mb-0">
...
<div class="rounded border p-4">
<ol class="breadcrumb pre-breadcrumb breadcrumb-line text-muted mb-0">
<li class="breadcrumb-item ">
<a href="#">Home</a>
</li>
<li class="breadcrumb-item ">
...
<div class="rounded border p-4">
<ol class="breadcrumb pre-breadcrumb breadcrumb-dot text-muted mb-0">
<li class="breadcrumb-item">
<a href="#">Home</a>
</li>
<li class="breadcrumb-item">
...
<div class="rounded border p-4">
<ol class="breadcrumb pre-breadcrumb breadcrumb-separatorless text-muted mb-0">
<li class="breadcrumb-item">
<a href="#">Home</a>
</li>
<li class="breadcrumb-item">
