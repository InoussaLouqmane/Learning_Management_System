<!--
    Ce fichier contient une partie commune aux pages auquels les étudiants ont accès ...
-->
...
<a href="exam.php"><i class="fas fa-clipboard-list"></i> <span>Exam list</span></a>
                ...
                <li>
                     <a href="note-details.php"><i class="fas fa-sticky-note"></i><span> Notes </span> <!-- <span class="menu-arrow"></span> --></a> 
                    <!-- <ul>
...
<a href="time-table.php"><i class="fas fa-table"></i> <span>Time Table</span></a>
                ...
                <li>
                    <a href="student-library.php"><i class="fas fa-book"></i> <span>Library</span></a>
                </li>
