                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="backend/traitement/post-filiere.php">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Code Filiere <span class="login-danger">*</span></label>
                                            <input type="text" name="id_filiere" class="form-control">
                                        </div>
                                    </div>
